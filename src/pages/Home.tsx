...
export default function Home({ onNavigate }) {
  // SIMPLE AUTO-SLIDE CAROUSEL STATE
  const [index, setIndex] = useState(0);

  useEffect(() => {
    const interval = setInterval(() => {
      setIndex((prev) => (prev + 1) % 6); // 6 images
  ...
  <div className="max-w-[1600px] mx-auto px-8 lg:px-12">
    <div className="grid lg:grid-cols-2 gap-20 items-center">
      ...
      <div>
        ...
        <p className="text-2xl sm:text-3xl font-medium text-gray-700 leading-relaxed mb-8">
    ...
    <div className="grid md:grid-cols-3 gap-10">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-4xl sm:text-5xl font-extrabold text-white mb-6">We don't just deliver products.</h2>
